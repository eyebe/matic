...
module.exports = {
    ...
    setUp: function(callback) {
        ...
        this.expectedResult = JSON.parse(fs.readFileSync('tests/testSchemas/mergeSchemas/expectedMergedPathFromRootRef.json', 'binary'));

        this.schema = [fs.readFileSync('tests/testSchemas/mergeSchemas/pathFromRootRef.json', 'binary')];
